...
public class ForestSprite extends BaseCreature {
	public ForestSprite(Cards game, Card card, CardImage cardImage, int slotIndex, PlayerImage owner, PlayerImage opponent) {
